...
def main():
    print("Benchmarking Trewrap Dune Analytics API Latency...")
    print("Simulating 5 concurrent queries to Dune SQL engine")
    
    runs = 100
    latencies = []
    for i in range(runs):
        # Simulate network latency + Dune execution time
