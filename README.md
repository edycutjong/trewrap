<div align="center">
  <img src="docs/assets/readme-hero.png" alt="Trewrap Hero" width="100%">
  
  <p><em>Spotify Wrapped for crypto wallets. 5 Dune SQL signals → AI persona → shareable card.</em></p>
  
  [![Live Demo](https://img.shields.io/badge/Live-Demo-brightgreen.svg)](https://dune.vercel.app)
  [![Pitch Video](https://img.shields.io/badge/Pitch-Video-red.svg)](https://youtube.com/your-video)
  [![GitHub](https://img.shields.io/badge/GitHub-Repository-black.svg)](https://github.com/edycutjong/frontier-dune)
</div>
...
**Trewrap** solves this by providing: 
Spotify Wrapped for crypto wallets. 5 Dune SQL signals → AI persona → shareable card.
...
1. **Clone the repo:**
   ```bash
   git clone https://github.com/edycutjong/frontier-dune.git
   cd frontier-dune
   ```
